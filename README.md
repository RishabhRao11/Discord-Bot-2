...
Automatic warnings — Sends a message reminding users not to swear (customizable).

Real-time monitoring — Reacts instantly when banned words are used.
...
When it detects a word from your profanity list, it sends a warning message (e.g., “Don’t swear!”).
...
Behavior and messages can be tuned depending on what you want your bot to do.

Improvements, extra commands, and more filters can be easily added.
